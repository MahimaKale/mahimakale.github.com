(function(){
    ...
    alert("Hello! Thank you for being my tester :) It is important to remember that this is a testing for the page and not you. Be open and frank about your experience here to help us make the best changes possible.Tasks to complete: 1.Navigate and familiarize yourself with the page. 2.Write down one word or a sentence about what you think the page is about. 3.Find the image with a pine cone and read about it");
